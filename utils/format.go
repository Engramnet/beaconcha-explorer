...
func FormatETH(num string) string {
	...
	return fmt.Sprintf("%.4f", floatNum/math.Pow10(18)) + " tGRAM"
}

func FormatETHFromGwei(gwei uint64) string {
	return fmt.Sprintf("%.4f", float64(gwei)/math.Pow10(9)) + " tGRAM"
}
...
func FormatFullETHFromGwei(gwei uint64) string {
	return fmt.Sprintf("%v tGRAM", uint64(float64(gwei)/math.Pow10(9)))
}
